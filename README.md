...
### Поддержка разных провайдеров (Новое)

Теперь программа работает не только с **Google Gemini**, но и с **OpenAI** API. Это позволяет использовать:
...
Больше не нужно править JSON-файлы вручную. В новой вкладке **Prompts** вы можете создавать свои сценарии, назначать горячие клавиши, цвета логов и промпты прямо в приложении. Перевод, рерайт, написание кода — настраивайте под себя.
